...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # parser.add_argument('--anno_pack_path', help='Path to package containing annotation json files',default="E:/VNL_Monocular_Depth_Prediction-master/datasets/NYUDV2/annotations")
        # ----------------added end----------------------
